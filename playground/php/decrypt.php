...
$initialization_vector = $system_title . substr($cipher_text, 14*2, 4*2);
$additional_authenticated_data = substr($cipher_text, 13*2, 1*2) . $authentication_key;
$authentication_tag = substr($cipher_text, -12*2);
