...
$system_title = substr ( $cipher_text, 4, 16);
$initialization_vector = $system_title . substr($cipher_text, 28, 8);
$additional_authenticated_data = substr($cipher_text, 26, 2) . $authentication_key;
$authentication_tag = substr($cipher_text, strlen($cipher_text)-24, strlen($cipher_text));

print($system_title . PHP_EOL);
print($initialization_vector . PHP_EOL);
print($additional_authenticated_data . PHP_EOL);
print($authentication_tag . PHP_EOL);
print(PHP_EOL);
print($cipher_text . PHP_EOL);
print(PHP_EOL);
